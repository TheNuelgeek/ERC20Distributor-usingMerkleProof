...
function main() {
  ...
  const filename = path.join(__dirname, "gen/small.csv");

  // what file should we write the merkle proofs too?
  const output_file = path.join(__dirname, "gen/address.json");
  ...
  const airdropContract = "0xBF1f5A50e35B8E52182a7Db39d2d877d335E8380";
